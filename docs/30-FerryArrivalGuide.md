# Eagle Bluff — Ferry & Arrival Guide
...
## Important: This Is Not a Washington State Ferry

The Herron Island ferry is **not** operated by Washington State Ferries (WSDOT). Do not use the WSF website or app for this crossing.

Herron Island is a **private island**. The ferry is operated by the [Homeowners' Association of Herron Island (HMCHI)](https://www.hmchi.org/).

**Official ferry page:** [hmchi.org/p/FERRY](https://www.hmchi.org/p/FERRY)
...
The crossing takes approximately **7 to 10 minutes**.

---

## Ferry Etiquette

<!-- TODO: Queue behavior, loading order, community norms from HMCHI ferry policy / guest handout -->

HMCHI also publishes a **Guest Information Handout** for visitors — ask your host or check the HMCHI site under *Information for Residents*.
...
## Arrival on Herron Island

<!-- TODO: Drive from ferry landing to Eagle Bluff, landmarks -->

---

## Property Access

<!-- TODO: Lockbox code procedure, gate, key, parking at property -->

---

## If You Miss the Ferry

<!-- TODO: Next departure, waiting options, who to call -->

---

## Emergency Transport

<!-- TODO: Water taxi or other options if applicable, contacts -->
...
<!-- TODO: Add ferry map, dock photos to assets/ferry/ -->
