...
| Aspect | Description |
|--------|-------------|
| **Pace** | Slow down, disconnect |
| **Nature** | Eagles, deer, seals, tides, beaches |
| **Access** | Ferry adventure — plan ahead |
| **Season** | Peak: May–September |
| **Not for** | Resort expectations, convenience-first travelers |
...
- <!-- TODO: Families seeking nature -->
- <!-- TODO: Couples retreat -->
- <!-- TODO: Remote workers who want quiet -->
- <!-- TODO: Wildlife enthusiasts -->

---

## Tone & Voice

- Warm, welcoming, honest
- Set expectations clearly (ferry, groceries, septic, quiet island)
- Emphasize experience over amenities list
- Professional boutique rental, not "someone's house"
